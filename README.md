# Basic Simple Example For Rest Full Web Services using Spring Mvc
This Project covers the example for Rest Services using GET & POST HTTP Methods.

## Running Spring rest locally

You can then access Restfull web service with the urls as below : <br>
GET -- http://localhost:8080/Basic-Example-Spring-Rest-Services/list-employees <br>
...
1. Json Format Data:
<img src="https://github.com/Sudarshan-Gowda/Basic-Example-Spring-Rest-Services/blob/master/docs/picture2.png" width="100%">

2. PostMan Get Data:
<img src="https://github.com/Sudarshan-Gowda/Basic-Example-Spring-Rest-Services/blob/master/docs/picture1.png" width="100%">

3. PostMan Post data:
<img src="https://github.com/Sudarshan-Gowda/Basic-Example-Spring-Rest-Services/blob/master/docs/picture3.png" width="100%">
